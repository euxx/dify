const translation = {
  ...
  welcome: 'Dobrodošli v AI Mate, prosimo, prijavite se za nadaljevanje.',
  ...
  license: {
    tip: 'Preden začnete z AI Mate Community Edition, preberite GitHub',
    link: 'Licenco odprte kode',
  },
  join: 'Pridruži se',
  joinTipStart: 'Vabimo vas, da se pridružite',
  joinTipEnd: 'ekipi na AI Mate',
  invalid: 'Povezava je potekla',
  explore: 'Razišči AI Mate',
  ...
  licenseExpiredTip: 'Licenca za AI Mate Enterprise za vaš delovni prostor je potekla. Če želite še naprej uporabljati AI Mate, se obrnite na skrbnika.',
  usePassword: 'Uporaba gesla',
  sendVerificationCode: 'Pošlji kodo za preverjanje',
  resetPasswordDesc: 'Vnesite e-poštni naslov, ki ste ga uporabili za prijavo na AI Mate, in poslali vam bomo e-poštno sporočilo za ponastavitev gesla.',
  ...
  licenseLostTip: 'Povezava z licenčnim strežnikom AI Mate ni uspela. Če želite še naprej uporabljati AI Mate, se obrnite na skrbnika.',
  licenseInactiveTip: 'Licenca AI Mate Enterprise za vaš delovni prostor je neaktivna. Če želite še naprej uporabljati AI Mate, se obrnite na skrbnika.',
}
