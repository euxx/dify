const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'AI Mate račun',
    langGeniusAccountTip: 'Vaš AI Mate račun in povezani uporabniški podatki.',
    editName: 'Uredi ime',
  ...
  members: {
    ...
    invitationSentTip: 'Povabilo poslano, in po prijavi v AI Mate bodo imeli dostop do vaših podatkov ekipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Gostitvena storitev OpenAI, ki jo ponuja AI Mate, vam omogoča uporabo modelov, kot je GPT-3.5. Preden porabite kvoto za preizkus, morate nastaviti druge ponudnike modelov.',
  ...
  modelProvider: {
    ...
    apiBasedExtension: {
      title: 'Razširitve API omogočajo centralizirano upravljanje API, kar poenostavi konfiguracijo za enostavno uporabo v aplikacijah AI Mate.',
      link: 'Naučite se, kako razviti svojo API razširitev.',
      linkUrl: 'https://localhost/features/extension/api_based_extension',
    ...
    about: {
      ...
      nowAvailable: 'AI Mate {{version}} je zdaj na voljo.',
      latestAvailable: 'AI Mate {{version}} je najnovejša različica na voljo.',
    },
    appMenus: {
      overview: 'Nadzor',
  ...
  apiBasedExtension: {
    ...
    title: 'Razširitve API zagotavljajo centralizirano upravljanje API, kar poenostavlja konfiguracijo za enostavno uporabo v aplikacijah AI Mate.',
    linkUrl: 'https://localhost/features/extension/api_based_extension',
  ...
  about: {
    updateNow: 'Posodobi zdaj',
    nowAvailable: 'AI Mate {{version}} je zdaj na voljo.',
    latestAvailable: 'AI Mate {{version}} je najnovejša različica, ki je na voljo.',
    changeLog: 'Dnevnik sprememb',
  },
  appMenus: {
