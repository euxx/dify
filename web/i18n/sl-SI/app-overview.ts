const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Ali preizkusite oblačno različico AI Mate s prosto kvoto',
  },
  overview: {
    title: 'Pregled',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Pomaga obiskovalcem razumeti, katere podatke aplikacija zbira, glejte <privacyPolicyLink>politiko zasebnosti</privacyPolicyLink> AI Mate.',
      ...
      embedded: {
        ...
        chromePlugin: 'Namestite AI Mate Chatbot razširitev za Chrome',
        copied: 'Kopirano',
        copy: 'Kopiraj',
      },
      qrcode: {
