const translation = {
  ...
  welcome: 'Witaj w AI Mate, zaloguj się, aby kontynuować.',
  email: 'Adres e-mail',
  ...
  license: {
    tip: 'Przed rozpoczęciem wersji społecznościowej AI Mate, przeczytaj GitHub',
    link: 'Licencję open-source',
  },
  join: 'Dołącz',
  joinTipStart: 'Zapraszam Cię do dołączenia do',
  joinTipEnd: 'zespołu na AI Mate',
  invalid: 'Link wygasł',
  explore: 'Odkryj AI Mate',
  ...
  resetPasswordDesc: 'Wpisz adres e-mail, którego użyłeś do rejestracji w AI Mate, a my wyślemy Ci wiadomość e-mail z prośbą o zresetowanie hasła.',
  or: 'LUB',
  ...
  licenseExpiredTip: 'Licencja AI Mate Enterprise dla Twojego obszaru roboczego wygasła. Skontaktuj się z administratorem, aby kontynuować korzystanie z AI Mate.',
  licenseLostTip: 'Nie udało się nawiązać połączenia z serwerem licencji AI Mate. Skontaktuj się z administratorem, aby kontynuować korzystanie z AI Mate.',
  licenseInactiveTip: 'Licencja AI Mate Enterprise dla Twojego obszaru roboczego jest nieaktywna. Skontaktuj się z administratorem, aby kontynuować korzystanie z AI Mate.',
}
