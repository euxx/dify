const translation = {
  ...
  intro1: 'Wiedzę można zintegrować z aplikacją AI Mate ',
  ...
  externalAPIPanelDescription: 'Interfejs API wiedzy zewnętrznej służy do łączenia się z bazą wiedzy poza AI Mate i pobierania wiedzy z tej bazy wiedzy.',
  chunkingMode: {
