const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Konto AI Mate',
    langGeniusAccountTip: 'Twoje konto AI Mate i powiązane dane użytkownika.',
  ...
  members: {
    ...
    invitationSentTip:
      'Zaproszenie zostało wysłane, a oni mogą zalogować się do AI Mate, aby uzyskać dostęp do danych Twojego zespołu.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Usługa hostowania OpenAI dostarczana przez AI Mate pozwala korzystać z modeli takich jak GPT-3.5. Przed wyczerpaniem limitu próbnego należy skonfigurować inne dostawców modeli.',
  ...
  apiBasedExtension: {
    title:
      'Rozszerzenia oparte na interfejsie API zapewniają scentralizowane zarządzanie interfejsami API, upraszczając konfigurację dla łatwego użytkowania w aplikacjach AI Mate.',
  ...
  about: {
    ...
    nowAvailable: 'AI Mate {{version}} jest teraz dostępny.',
    latestAvailable: 'AI Mate {{version}} jest najnowszą dostępną wersją.',
  },
  appMenus: {
