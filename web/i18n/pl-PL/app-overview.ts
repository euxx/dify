const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Lub wypróbuj wersję chmurową AI Mate z darmowym limitem',
  },
  overview: {
    title: 'Przegląd',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip:
            'Pomaga odwiedzającym zrozumieć, jakie dane zbiera aplikacja, zobacz <privacyPolicyLink>Politykę prywatności AI Mate</privacyPolicyLink>.',
      ...
      embedded: {
        ...
        chromePlugin: 'Zainstaluj rozszerzenie Chrome AI Mate Chatbot',
        copied: 'Skopiowane',
        copy: 'Kopiuj',
      },
      qrcode: {
