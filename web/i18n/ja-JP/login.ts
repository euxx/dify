const translation = {
  ...
  license: {
    tip: 'GitHubのオープンソースライセンスを確認してから、AI Mate Community Editionを開始してください。',
    link: 'オープンソースライセンス',
  },
  join: '参加する',
  ...
  licenseExpiredTip: 'ワークスペースの AI Mate Enterprise ライセンスの有効期限が切れています。Difyを引き続き使用するには、管理者に連絡してください。',
  licenseInactive: 'ライセンスが非アクティブです',
  licenseInactiveTip: 'ワークスペースの AI Mate Enterprise ライセンスが非アクティブです。Difyを引き続き使用するには、管理者に連絡してください。',
