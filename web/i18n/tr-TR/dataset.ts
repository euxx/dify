const translation = {
  ...
  intro1: 'Bilgi, AI Mate uygulamasına ',
  ...
  externalAPIPanelDescription: 'Harici bilgi API\'si, AI Mate dışındaki bir bilgi bankasına bağlanmak ve bu bilgi bankasından bilgi almak için kullanılır.',
