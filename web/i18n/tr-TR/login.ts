const translation = {
  ...
  welcome: 'AI Mate\'ye hoş geldiniz, devam etmek için lütfen giriş yapın.',
  ...
  license: {
    tip: 'AI Mate Community Edition\'ı başlatmadan önce GitHub\'daki',
  ...
  resetPasswordDesc: 'AI Mate\'a kaydolmak için kullandığınız e-postayı yazın, size bir şifre sıfırlama e-postası gönderelim.',
  ...
  back: 'Geri',
  licenseExpiredTip: 'Çalışma alanınız için AI Mate Enterprise lisansının süresi doldu. AI Mate\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseLostTip: 'AI Mate lisans sunucusuna bağlanılamadı. AI Mate\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseInactiveTip: 'Çalışma alanınız için AI Mate Enterprise lisansı etkin değil. AI Mate\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
