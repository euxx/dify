const translation = {
  ...
  welcome: 'Ласкаво просимо до AI Mate, будь ласка, увійдіть, щоб продовжити.',
  ...
  license: {
    tip: 'Перед запуском AI Mate Community Edition ознайомтеся з ліцензією з відкритим кодом на GitHub',
    link: 'Ліцензія з відкритим кодом',
  },
  join: 'Приєднуйтесь',
  joinTipStart: 'Запрошуємо вас приєднатися',
  joinTipEnd: 'команда AI Mate',
  invalid: 'Посилання застаріло',
  explore: 'Досліджуйте AI Mate',
  ...
  resetPasswordDesc: 'Введіть адресу електронної пошти, яку ви використовували для реєстрації на AI Mate, і ми надішлемо вам електронний лист для скидання пароля.',
  resetPassword: 'Скинути пароль',
  licenseLostTip: 'Не вдалося підключити сервер ліцензій AI Mate. Будь ласка, зверніться до свого адміністратора, щоб продовжити користуватися AI Mate.',
  licenseExpired: 'Термін дії ліцензії минув',
  licenseInactive: 'Ліцензія неактивна',
  licenseLost: 'Ліцензію втрачено',
  licenseInactiveTip: 'Ліцензія AI Mate Enterprise для вашої робочої області неактивна. Будь ласка, зверніться до свого адміністратора, щоб продовжити користуватися AI Mate.',
  licenseExpiredTip: 'Термін дії ліцензії AI Mate Enterprise для вашого робочого простору закінчився. Будь ласка, зверніться до свого адміністратора, щоб продовжити користуватися AI Mate.',
}
