const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Cuenta AI Mate',
    langGeniusAccountTip: 'Tu cuenta AI Mate y los datos de usuario asociados.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitación enviada, y pueden iniciar sesión en AI Mate para acceder a tus datos del equipo.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'El servicio de hospedaje OpenAI proporcionado por AI Mate te permite usar modelos como GPT-3.5. Antes de que se agote tu cuota de prueba, necesitas configurar otros proveedores de modelos.',
  ...
  apiBasedExtension: {
    title: 'Las extensiones basadas en API proporcionan una gestión centralizada de API, simplificando la configuración para su fácil uso en las aplicaciones de AI Mate.',
  ...
  about: {
    ...
    nowAvailable: 'AI Mate {{version}} ya está disponible.',
    latestAvailable: 'AI Mate {{version}} es la última versión disponible.',
  },
  appMenus: {
    overview: 'Monitoreo',
    promptEng: 'Orquestar',
