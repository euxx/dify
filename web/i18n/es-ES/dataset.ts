const translation = {
  ...
  didYouKnow: '¿Sabías?',
  intro1: 'El Conocimiento se puede integrar en la aplicación AI Mate ',
  ...
  externalAPIPanelDescription: 'La API de conocimiento externo se utiliza para conectarse a una base de conocimiento fuera de AI Mate y recuperar conocimiento de esa base de conocimiento.',
