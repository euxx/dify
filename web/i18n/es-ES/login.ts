const translation = {
  ...
  welcome: 'Bienvenido a AI Mate, por favor inicia sesión para continuar.',
  ...
  resetPasswordDesc: 'Escriba el correo electrónico que utilizó para registrarse en AI Mate y le enviaremos un correo electrónico de restablecimiento de contraseña.',
  ...
  licenseInactiveTip: 'La licencia de AI Mate Enterprise para su espacio de trabajo está inactiva. Póngase en contacto con su administrador para seguir utilizando AI Mate.',
  licenseExpired: 'Licencia caducada',
  licenseLost: 'Licencia perdida',
  licenseExpiredTip: 'La licencia de AI Mate Enterprise para su espacio de trabajo ha caducado. Póngase en contacto con su administrador para seguir utilizando AI Mate.',
  licenseLostTip: 'No se pudo conectar el servidor de licencias de Dife. Póngase en contacto con su administrador para seguir utilizando AI Mate.',
}
