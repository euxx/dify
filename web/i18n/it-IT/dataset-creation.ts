const translation = {
  ...
  stepOne: {
    ...
    website: {
      ...
      firecrawlDocLink:
        'https://localhost/guides/knowledge-base/sync_from_website',
      options: 'Opzioni',
  ...
  otherDataSource: {
    ...
    description: 'Attualmente, la knowledge base di AI Mate ha solo fonti di dati limitate. Contribuire con una fonte di dati alla knowledge base di AI Mate è un modo fantastico per migliorare la flessibilità e la potenza della piattaforma per tutti gli utenti. La nostra guida ai contributi ti aiuta a iniziare. Clicca sul link sottostante per saperne di più.',
  },
}
