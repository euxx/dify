const translation = {
  ...
  welcome: 'Benvenuto su AI Mate, per favore accedi per continuare.',
  ...
  license: {
    tip: 'Prima di avviare AI Mate Community Edition, leggi su GitHub',
    link: 'Licenza open-source',
  },
  join: 'Unisciti',
  joinTipStart: 'Invitato a unirti al',
  joinTipEnd: 'team su AI Mate',
  invalid: 'Il link è scaduto',
  explore: 'Esplora AI Mate',
  ...
  resetPasswordDesc: 'Digita l\'e-mail che hai utilizzato per registrarti su AI Mate e ti invieremo un\'e-mail per reimpostare la password.',
  ...
  licenseLostTip: 'Impossibile connettersi al server licenze AI Mate. Contatta il tuo amministratore per continuare a utilizzare AI Mate.',
  licenseExpired: 'Licenza scaduta',
  licenseLost: 'Licenza persa',
  licenseExpiredTip: 'La licenza AI Mate Enterprise per la tua area di lavoro è scaduta. Contatta il tuo amministratore per continuare a utilizzare AI Mate.',
  licenseInactiveTip: 'La licenza AI Mate Enterprise per la tua area di lavoro è inattiva. Contatta il tuo amministratore per continuare a utilizzare AI Mate.',
