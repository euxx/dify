const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Account AI Mate',
    langGeniusAccountTip: 'Il tuo account AI Mate e i dati utente associati.',
  ...
  members: {
    ...
    invitationSentTip:
      'Invito inviato, e possono accedere a AI Mate per accedere ai dati del tuo team.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Il servizio di hosting OpenAI fornito da AI Mate ti consente di utilizzare modelli come GPT-3.5. Prima che la tua quota di prova sia esaurita, devi configurare altri fornitori di modelli.',
  ...
  apiBasedExtension: {
    title:
      'Le estensioni API forniscono una gestione centralizzata delle API, semplificando la configurazione per un facile utilizzo nelle applicazioni di AI Mate.',
  ...
  about: {
    ...
    nowAvailable: 'AI Mate {{version}} è ora disponibile.',
    latestAvailable: 'AI Mate {{version}} è l\'ultima versione disponibile.',
  },
  appMenus: {
