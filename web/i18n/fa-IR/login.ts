const translation = {
  ...
  welcome: 'به AI Mate خوش آمدید، لطفا برای ادامه وارد شوید.',
  email: 'آدرس ایمیل',
  ...
  license: {
    tip: 'قبل از شروع AI Mate Community Edition، GitHub را بخوانید',
    link: 'مجوز منبع باز',
  },
  join: 'عضویت',
  joinTipStart: 'شما را دعوت می‌کنیم به',
  joinTipEnd: 'تیم در AI Mate',
  invalid: 'لینک منقضی شده است',
  explore: 'کاوش AI Mate',
  ...
  resetPasswordDesc: 'ایمیلی را که برای ثبت نام در AI Mate استفاده کرده اید تایپ کنید و ما یک ایمیل بازنشانی رمز عبور برای شما ارسال خواهیم کرد.',
  licenseInactive: 'مجوز غیر فعال',
  licenseLost: 'مجوز گم شده است',
  licenseExpired: 'مجوز منقضی شده است',
  licenseExpiredTip: 'مجوز AI Mate Enterprise برای فضای کاری شما منقضی شده است. لطفا برای ادامه استفاده از AI Mate با سرپرست خود تماس بگیرید.',
  licenseInactiveTip: 'مجوز AI Mate Enterprise برای فضای کاری شما غیرفعال است. لطفا برای ادامه استفاده از AI Mate با سرپرست خود تماس بگیرید.',
  licenseLostTip: 'اتصال سرور مجوز AI Mate انجام نشد. لطفا برای ادامه استفاده از AI Mate با سرپرست خود تماس بگیرید.',
}
