const translation = {
  ...
  stepOne: {
    ...
    website: {
      ...
      firecrawlDocLink: '<a href="https://localhost/guides/knowledge-base/sync-from-website">https://localhost/guides/knowledge-base/sync-from-website</a>',
      options: 'گزینهها',
  ...
  otherDataSource: {
    ...
    description: 'در حال حاضر، پایگاه دانش AI Mate فقط منابع داده محدودی دارد. کمک به یک منبع داده به پایگاه دانش AI Mate راهی فوق العاده برای کمک به افزایش انعطاف پذیری و قدرت پلتفرم برای همه کاربران است. راهنمای مشارکت ما شروع کار را آسان می کند. لطفا برای کسب اطلاعات بیشتر روی لینک زیر کلیک کنید.',
