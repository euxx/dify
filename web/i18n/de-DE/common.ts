const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'AI Mate-Konto',
    langGeniusAccountTip: 'Ihr AI Mate-Konto und zugehörige Benutzerdaten.',
  ...
  members: {
    ...
    invitationSentTip: 'Einladung gesendet, und sie können sich bei AI Mate anmelden, um auf Ihre Teamdaten zuzugreifen.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Der OpenAI-Hostingdienst von AI Mate ermöglicht es Ihnen, Modelle wie GPT-3.5 zu verwenden. Bevor Ihr Probe-Kontingent aufgebraucht ist, müssen Sie andere Modellanbieter einrichten.',
  ...
  about: {
    ...
    nowAvailable: 'AI Mate {{version}} ist jetzt verfügbar.',
    latestAvailable: 'AI Mate {{version}} ist die neueste verfügbare Version.',
  },
  appMenus: {
    overview: 'Übersicht',
