const translation = {
  ...
  welcome: 'Willkommen bei AI Mate, bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit AI Mate Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf AI Mate beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: 'AI Mate erkunden',
  ...
  resetPasswordDesc: 'Geben Sie die E-Mail-Adresse ein, mit der Sie sich bei AI Mate angemeldet haben, und wir senden Ihnen eine E-Mail zum Zurücksetzen des Passworts.',
  ...
  licenseLostTip: 'Fehler beim Verbinden des AI Mate-Lizenzservers. Wenden Sie sich an Ihren Administrator, um AI Mate weiterhin zu verwenden.',
  licenseInactive: 'Lizenz inaktiv',
  licenseInactiveTip: 'Die AI Mate Enterprise-Lizenz für Ihren Arbeitsbereich ist inaktiv. Wenden Sie sich an Ihren Administrator, um AI Mate weiterhin zu verwenden.',
  licenseExpiredTip: 'Die AI Mate Enterprise-Lizenz für Ihren Arbeitsbereich ist abgelaufen. Wenden Sie sich an Ihren Administrator, um AI Mate weiterhin zu verwenden.',
