const translation = {
  ...
  intro1: 'Das Wissen kann in die AI Mate-Anwendung ',
  intro2: 'als Kontext',
  intro3: ',',
  intro4: 'oder es ',
  ...
  externalAPIPanelDescription: 'Die API für externes Wissen wird verwendet, um eine Verbindung zu einer Wissensdatenbank außerhalb von AI Mate herzustellen und Wissen aus dieser Wissensdatenbank abzurufen.',
