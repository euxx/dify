const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'AI Mate account',
    langGeniusAccountTip: 'Your AI Mate account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to AI Mate to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by AI Mate allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across AI Mate\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'AI Mate {{version}} is now available.',
    latestAvailable: 'AI Mate {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
