const translation = {
  ...
  welcome: '👋 Welcome to AI Mate, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting AI Mate Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on AI Mate',
  invalid: 'The link has expired',
  explore: 'Explore AI Mate',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on AI Mate and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The AI Mate Enterprise license for your workspace has expired. Please contact your administrator to continue using AI Mate.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect AI Mate license server. Please contact your administrator to continue using AI Mate.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The AI Mate Enterprise license for your workspace is inactive. Please contact your administrator to continue using AI Mate.',
}
