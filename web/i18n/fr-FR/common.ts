const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Compte AI Mate',
    langGeniusAccountTip: 'Votre compte AI Mate et les données utilisateur associées.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation envoyée, et ils peuvent se connecter à AI Mate pour accéder aux données de votre équipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Le service d\'hébergement OpenAI fourni par AI Mate vous permet d\'utiliser des modèles tels que GPT-3.5. Avant que votre quota d\'essai ne soit épuisé, vous devez configurer d\'autres fournisseurs de modèles.',
  ...
  apiBasedExtension: {
    title: 'Les extensions API fournissent une gestion centralisée des API, simplifiant la configuration pour une utilisation facile à travers les applications de AI Mate.',
    link: 'Apprenez comment développer votre propre Extension API.',
    linkUrl: 'https://localhost/fonctionnalites/extension/extension_basee_sur_api',
  ...
  about: {
    ...
    nowAvailable: 'AI Mate {{version}} est maintenant disponible.',
    latestAvailable: 'AI Mate {{version}} est la dernière version disponible.',
  },
  appMenus: {
