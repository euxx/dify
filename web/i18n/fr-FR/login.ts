const translation = {
  ...
  welcome: 'Bienvenue sur AI Mate, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer AI Mate Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur AI Mate',
  invalid: 'Le lien a expiré',
  explore: 'Explorez AI Mate',
  ...
  resetPasswordDesc: 'Tapez l’adresse e-mail que vous avez utilisée pour vous inscrire sur AI Mate et nous vous enverrons un e-mail de réinitialisation de mot de passe.',
  usePassword: 'Utiliser le mot de passe',
  licenseInactiveTip: 'La licence AI Mate Enterprise de votre espace de travail est inactive. Veuillez contacter votre administrateur pour continuer à utiliser AI Mate.',
  licenseLostTip: 'Échec de la connexion au serveur de licences AI Mate. Veuillez contacter votre administrateur pour continuer à utiliser AI Mate.',
  licenseExpired: 'Licence expirée',
  licenseLost: 'Licence perdue',
  licenseExpiredTip: 'La licence AI Mate Enterprise de votre espace de travail a expiré. Veuillez contacter votre administrateur pour continuer à utiliser AI Mate.',
