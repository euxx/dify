const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'AI Mate 계정',
    langGeniusAccountTip: 'AI Mate 계정과 관련된 사용자 데이터.',
    editName: '이름 편집',
  ...
  apiBasedExtension: {
    title: 'API 기반 확장은 AI Mate 애플리케이션 전체에서 간편한 사용을 위한 설정을 단순화하고 집중적인 API 관리를 제공합니다.',
  ...
  about: {
    changeLog: '변경 로그',
    updateNow: '지금 업데이트',
    nowAvailable: 'AI Mate {{version}} 사용 가능합니다.',
    latestAvailable: 'AI Mate {{version}} 최신 버전입니다.',
  },
  appMenus: {
    overview: '모니터링',
    promptEng: '오케스트레이트',
