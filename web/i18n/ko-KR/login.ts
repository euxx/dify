const translation = {
  ...
  license: {
    tip: 'AI Mate Community Edition을 시작하기 전에 GitHub의',
    link: '오픈 소스 라이선스',
  },
  join: '가입하기',
  ...
  licenseInactiveTip: '작업 영역에 대한 AI Mate Enterprise 라이선스가 비활성 상태입니다. Dify를 계속 사용하려면 관리자에게 문의하십시오.',
  licenseLost: '라이센스 분실',
  licenseLostTip: 'AI Mate 라이선스 서버에 연결하지 못했습니다. Dify를 계속 사용하려면 관리자에게 문의하십시오.',
  licenseInactive: 'License Inactive(라이선스 비활성)',
  licenseExpired: '라이센스가 만료되었습니다.',
  licenseExpiredTip: '작업 영역에 대한 AI Mate Enterprise 라이선스가 만료되었습니다. Dify를 계속 사용하려면 관리자에게 문의하십시오.',
}
