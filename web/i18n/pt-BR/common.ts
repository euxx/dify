const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Conta AI Mate',
    langGeniusAccountTip: 'Sua conta AI Mate e dados de usuário associados.',
  ...
  members: {
    ...
    invitationSentTip: 'Convite enviado e eles podem fazer login no AI Mate para acessar os dados da sua equipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'O serviço de hospedagem OpenAI fornecido pela AI Mate permite que você use modelos como GPT-3.5. Antes que sua cota de teste seja esgotada, você precisa configurar outros fornecedores de modelos.',
      callTimes: 'Chamadas',
  ...
  apiBasedExtension: {
    title: 'As extensões de API fornecem gerenciamento centralizado de API, simplificando a configuração para uso fácil em todos os aplicativos da AI Mate.',
  ...
  about: {
    ...
    nowAvailable: 'AI Mate {{version}} já está disponível.',
    latestAvailable: 'AI Mate {{version}} é a última versão disponível.',
  },
  appMenus: {
