const translation = {
  ...
  welcome: 'Bem-vindo ao AI Mate, faça login para continuar.',
  ...
  license: {
    tip: 'Antes de começar a usar a Edição Comunitária do AI Mate, leia a',
    link: 'Licença de código aberto do GitHub',
  },
  join: 'Participar',
  joinTipStart: 'Convidamos você a participar da',
  joinTipEnd: 'equipe no AI Mate',
  invalid: 'O link expirou',
  explore: 'Explorar o AI Mate',
  ...
  resetPasswordDesc: 'Digite o e-mail que você usou para se inscrever no AI Mate e enviaremos um e-mail de redefinição de senha.',
  sendVerificationCode: 'Enviar código de verificação',
  usePassword: 'Usar senha',
  licenseInactiveTip: 'A licença do AI Mate Enterprise para seu espaço de trabalho está inativa. Entre em contato com o administrador para continuar usando o AI Mate.',
  licenseLostTip: 'Falha ao conectar o servidor de licenças AI Mate. Entre em contato com o administrador para continuar usando o AI Mate.',
  licenseExpired: 'Licença expirada',
  licenseLost: 'Licença perdida',
  licenseInactive: 'Licença inativa',
  licenseExpiredTip: 'A licença do AI Mate Enterprise para seu espaço de trabalho expirou. Entre em contato com o administrador para continuar usando o AI Mate.',
}
