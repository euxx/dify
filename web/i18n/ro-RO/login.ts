const translation = {
  ...
  welcome: 'Bine ai venit la AI Mate, te rugăm să te autentifici pentru a continua.',
  ...
  or: 'SAU',
  resetPasswordDesc: 'Tastați e-mailul pe care l-ați folosit pentru a vă înscrie pe AI Mate și vă vom trimite un e-mail de resetare a parolei.',
  changePasswordBtn: 'Setați o parolă',
  licenseLostTip: 'Nu s-a reușit conectarea serverului de licențe AI Mate. Contactați administratorul pentru a continua să utilizați AI Mate.',
  licenseInactive: 'Licență inactivă',
  licenseInactiveTip: 'Licența AI Mate Enterprise pentru spațiul de lucru este inactivă. Contactați administratorul pentru a continua să utilizați AI Mate.',
  licenseExpired: 'Licență expirată',
  licenseLost: 'Licență pierdută',
  licenseExpiredTip: 'Licența AI Mate Enterprise pentru spațiul de lucru a expirat. Contactați administratorul pentru a continua să utilizați AI Mate.',
}
