const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Sau încercați versiunea cloud a AI Mate cu cotă gratuită',
  },
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajută vizitatorii să înțeleagă datele pe care le colectează aplicația, consultați <privacyPolicyLink>Politica de confidențialitate</privacyPolicyLink> a AI Mate.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalați extensia Chrome AI Mate Chatbot',
        copied: 'Copiat',
        copy: 'Copiați',
      },
      qrcode: {
