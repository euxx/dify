const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Или попробуйте облачную версию AI Mate с бесплатной квотой',
  },
  overview: {
    title: 'Обзор',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Помогает посетителям понять, какие данные собирает приложение, см. <privacyPolicyLink>Политику конфиденциальности</privacyPolicyLink> AI Mate.',
      ...
      embedded: {
        ...
        chromePlugin: 'Установите расширение AI Mate Chatbot для Chrome',
        copied: 'Скопировано',
        copy: 'Копировать',
      },
      qrcode: {
