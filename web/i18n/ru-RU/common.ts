const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Учетная запись AI Mate',
    langGeniusAccountTip: 'Ваша учетная запись AI Mate и связанные с ней пользовательские данные.',
  ...
  members: {
    ...
    invitationSentTip: 'Приглашение отправлено, и они могут войти в AI Mate, чтобы получить доступ к данным вашей команды.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Хостинговая служба OpenAI, предоставляемая AI Mate, позволяет вам использовать такие модели, как GPT-3.5. Прежде чем ваша пробная квота будет исчерпана, вам необходимо настроить других поставщиков моделей.',
  ...
  apiBasedExtension: {
    title: 'API-расширения обеспечивают централизованное управление API, упрощая настройку для удобного использования в приложениях AI Mate.',
  ...
  about: {
    ...
    nowAvailable: 'AI Mate {{version}} теперь доступен.',
    latestAvailable: 'AI Mate {{version}} - последняя доступная версия.',
  },
  appMenus: {
    overview: 'Мониторинг',
