const translation = {
  ...
  intro1: 'Базу знаний можно интегрировать в приложение AI Mate ',
  ...
  externalAPIPanelDescription: 'Внешний API базы знаний используется для подключения к базе знаний за пределами AI Mate и извлечения знаний из этой базы знаний.',
  chunkingMode: {
    general: 'Общее',
