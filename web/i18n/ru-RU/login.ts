const translation = {
  ...
  welcome: 'Добро пожаловать в AI Mate, пожалуйста, войдите, чтобы продолжить.',
  ...
  license: {
    tip: 'Перед запуском AI Mate Community Edition ознакомьтесь с лицензией GitHub',
    link: 'Лицензия с открытым исходным кодом',
  },
  join: 'Присоединиться',
  joinTipStart: 'Приглашаем вас присоединиться к',
  joinTipEnd: 'команде на AI Mate',
  invalid: 'Ссылка истекла',
  explore: 'Изучить AI Mate',
  ...
  resetPasswordDesc: 'Введите адрес электронной почты, который вы использовали для регистрации в AI Mate, и мы отправим вам электронное письмо для сброса пароля.',
  or: 'ИЛИ',
  licenseInactive: 'Лицензия неактивна',
  licenseLostTip: 'Не удалось подключить сервер лицензий AI Mate. Обратитесь к своему администратору, чтобы продолжить использование AI Mate.',
  licenseExpired: 'Срок действия лицензии истек',
  licenseLost: 'Утеряна лицензия',
  licenseInactiveTip: 'Лицензия AI Mate Enterprise для рабочего пространства неактивна. Обратитесь к своему администратору, чтобы продолжить использование AI Mate.',
  licenseExpiredTip: 'Срок действия лицензии AI Mate Enterprise для рабочего пространства истек. Обратитесь к своему администратору, чтобы продолжить использование AI Mate.',
}
