const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'หรือลองใช้ AI Mate เวอร์ชันคลาวด์พร้อมใบเสนอราคาฟรี',
  },
  overview: {
    title: 'ภาพรวม',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'ช่วยให้ผู้เยี่ยมชมเข้าใจข้อมูลที่แอปพลิเคชันรวบรวม โปรดดูนโยบาย<privacyPolicyLink>ความเป็นส่วนตัว</privacyPolicyLink>ของ AI Mate',
      ...
      embedded: {
        ...
        chromePlugin: 'ติดตั้งส่วนขยาย AI Mate Chatbot Chrome',
        copied: 'คัด ลอก',
        copy: 'ลอก',
      },
      qrcode: {
      ...
      customize: {
        ...
        way1: {
          ...
          step1Operation: 'AI Mate-Web ไคลเอ็นต์',
