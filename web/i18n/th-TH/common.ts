const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'บัญชี AI Mate',
    langGeniusAccountTip: 'บัญชี AI Mate และข้อมูลผู้ใช้ที่เกี่ยวข้อง',
    editName: 'แก้ไขชื่อ',
  ...
  members: {
    ...
    invitationSentTip: 'ส่งคําเชิญแล้ว และพวกเขาสามารถลงชื่อเข้าใช้ AI Mate เพื่อเข้าถึงข้อมูลทีมของคุณได้',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      onTrial: 'ทดลองใช้',
      exhausted: 'โควต้าหมด',
      desc: 'บริการโฮสติ้ง OpenAI ที่ให้บริการโดย AI Mate ช่วยให้คุณใช้โมเดลต่างๆ เช่น GPT-3.5 ก่อนที่โควต้าการทดลองใช้ของคุณจะหมด คุณจําเป็นต้องตั้งค่าผู้ให้บริการรุ่นอื่นๆ',
      callTimes: 'เวลาโทร',
  ...
  apiBasedExtension: {
    title: 'ส่วนขยาย API ให้การจัดการ API แบบรวมศูนย์ ทําให้การกําหนดค่าง่ายขึ้นเพื่อให้ใช้งานได้ง่ายในแอปพลิเคชันของ AI Mate',
    link: 'เรียนรู้วิธีพัฒนาส่วนขยาย API ของคุณเอง',
    linkUrl: 'https://mate.aimateplus.com/features/extension/api_based_extension',
  ...
  about: {
    ...
    nowAvailable: 'AI Mate {{version}} พร้อมใช้งานแล้ว',
    latestAvailable: 'AI Mate {{version}} เป็นเวอร์ชันล่าสุดที่มี',
  },
  appMenus: {
    overview: 'ตรวจ สอบ',
    promptEng: 'ออเคสตร้า',
